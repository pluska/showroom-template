...
export async function createUser(data: any) {
  ...
  // El correo se guarda normalizado y se comprueba con ese mismo valor. Antes
  // se buscaba en minúsculas pero se insertaba tal cual venía del formulario,
  // así que "Ana@X.com" y "ana@x.com" pasaban las dos la comprobación y
  // acababan siendo dos cuentas para el mismo buzón.
...
export async function updateUser(id: string, data: any) {
  ...
  // Mismo criterio que en createUser: se normaliza una vez y ese valor es el
  // que se comprueba y el que se guarda.
  const email = String(data.email || "").trim().toLowerCase();
