...
export const units = sqliteTable('units', {
  ...
  // 'FLAT' (por defecto si viene vacío) | 'DUPLEX' | 'STORAGE' | 'TERRACE'.
  // getFloorsData ya lee este campo en vez de deducir el tipo del identificador.
  // TODO: falta exponerlo en el panel de Unidades — hoy solo se puede fijar en
  // la semilla o a mano — y que src/app/contact/page.tsx deje de deducir el
  // dúplex por "el mismo identificador en dos plantas".
  type: text('type'),
